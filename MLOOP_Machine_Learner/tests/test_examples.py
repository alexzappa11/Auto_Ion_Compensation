...
class TestExamples(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.override_dict = {'file_log_level': logging.WARNING,
                             'console_log_level': logging.DEBUG, 'visualizations': False}
    ...
    def asserts_for_cost_and_params(self, controller):
        ...
        self.assertTrue(np.sum(np.square(controller.best_params))
                        <= controller.target_cost)
